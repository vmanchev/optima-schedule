...
@Component({
  selector: "optima-schedule",
  templateUrl: "./optima-schedule.component.html",
  styleUrls: ["./optima-schedule.component.scss"],
})
export class OptimaScheduleComponent implements OnInit {
  @Input()
  interval: number;
  @Input()
  startTime: Date;
